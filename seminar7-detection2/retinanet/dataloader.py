...
class CocoDataset(Dataset):
    ...
    def load_annotations(self, image_index):
        ...
        annotations     = np.zeros((0, 5)) # empty
        ...
        # iterate over each annotation & append to the result np.array
        for idx, a in enumerate(coco_annotations):
            ...
            annotation[0, :4] = a['bbox'] # 4 points
            annotation[0, 4]  = self.coco_label_to_label(a['category_id']) # id
